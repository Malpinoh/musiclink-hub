    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 max-w-md mx-auto w-full">
          ...
          >
            <div className="absolute -inset-6 bg-gradient-to-r from-primary/40 to-accent/40 blur-3xl rounded-full opacity-50 animate-pulse-glow" />
            {campaign.artwork_url ? (
          ...
          {/* Countdown */}
          {countdown && (
            <motion.div className="mb-8" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }}>
          ...
          {/* CTA / Fan form */}
          <motion.div className="w-full" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            {submitted ? (
              ...
              <div className="glass-card p-6 space-y-4">
                ...
                <div>
                  <Label>Name</Label>
                  <Input placeholder="Your name" value={fanName} onChange={(e) => setFanName(e.target.value)} className="mt-1" />
                </div>
                <div>
                  <Label>Email</Label>
                  <Input type="email" placeholder="you@email.com" value={fanEmail} onChange={(e) => setFanEmail(e.target.value)} className="mt-1" />
                </div>
